...
function filterName($field){
    ...
    $field = filter_var(trim($field), FILTER_SANITIZE_STRING); //The FILTER_SANITIZE_STRING filter removes tags and remove or encode special characters from a string.
